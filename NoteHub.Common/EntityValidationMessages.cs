namespace NoteHub.Common
{
    public static class EntityValidationMessages
    {
        ...
        public static class Note
        {
            ...
            public const string NoteTitleLengthMessage = "Title must be between {2} and {1} characters.";
            public const string NoteContentLengthMessage = "Content must be between {2} and {1} characters.";
        }
